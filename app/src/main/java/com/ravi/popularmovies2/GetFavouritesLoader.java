...
class GetFavouritesLoader extends AsyncTaskLoader<Cursor> {

    // Initialize a Cursor, this will hold all the task data
    private Cursor mTaskData = null;
    private String selectionArgs, selection;

    GetFavouritesLoader(Context context, String selectionArgs) {
        super(context);
    ...
    public Cursor loadInBackground() {
        ...
        try {
            if(selectionArgs != null) {
                selection = FavoritesContract.FavoritesEntry.COLUMN_ID + "=?";
            }
